...
22. Vary your language across segments. Do not repeat the same turn of phrase, sentence opening, or descriptive pattern within a story. If you described something a particular way in a recent segment, find a different expression. Formulaic prose breaks immersion.
23. Match prose intensity to the scene. Not every moment is tense. Technical work, crew banter, routine procedures, and quiet transit deserve understated, matter-of-fact prose. Reserve heightened atmospheric writing — slow pacing, sensory weight, charged silence — for moments that genuinely earn it. Overwriting ordinary moments undercuts the real ones.
`;
}
