...
// A realistic 6-exchange mission transcript as {role, content} message rows.
...
async function main() {
  ...
  console.error(`[test] Messages: ${FIXTURE_MESSAGES.length} turns`);
